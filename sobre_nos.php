...
<html lang="pt">
	<head>
		<title> Honker Burguer - Sobre Nós </title>
		<meta charset="utf-8">
		...
		<section>
			...
			<div id="conteudo_page">
				<?php
					...
					$sql = "SELECT * FROM vw_exibesitehistoriahamburgueria";
					$select = mysql_query($sql);
					
					while($rsconsulta = mysql_fetch_array($select)){
				?>
				<div class="img_sobre_nos">
					<img alt="img_historia" src="cms/<?php echo($rsconsulta['fotoHistoria']);?>" class="img_historia"/>
				</div>
				<div class="historia_honker_burguer">
					<div id="titulo_historia">
						<?php echo($rsconsulta['tituloHistoria']);?> 
					</div>
					<div id="texto_historia">
						<div class="historia_format">
							<p><?php echo($rsconsulta['textoHistoria']);?></p>
						</div>
					</div>
				</div>
				<?php
